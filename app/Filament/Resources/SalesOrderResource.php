...
class SalesOrderResource extends Resource
{
    ...
    {
        return __('erp.sales_order');
    }

    public static function getPluralLabel(): string
    {
        return __('erp.sales_orders');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
                ...
                Forms\Components\Section::make(__('erp.order_details'))->schema([
                    Forms\Components\Grid::make(3)->schema([
                        Forms\Components\TextInput::make('number')
                            ->label(__('erp.order_number'))
                            ->default(fn() => SalesOrder::generateNumber())
                            ->disabled()
                            ->dehydrated()
                            ->required(),
                        ...
                        Forms\Components\Select::make('status')
                            ...
                            ->options([
                                ...
                                'shipped' => __('erp.shipped'),
                                'delivered' => __('erp.delivered'),
            ...
            ])->columnSpan(['lg' => fn(?SalesOrder $record) => $record === null ? 3 : 2]),
            ...
            ])->columnSpan(['lg' => 1])->hidden(fn(?SalesOrder $record) => $record === null),
        ])->columns(3);
    }
