    ...
    <div>
        ...
        <form action="{{ route('deals.store') }}" method="POST">
            ...
            <h3
                ...
                {{ __('messages.new_deal_opportunity') }}
            </h3>

            <div class="mb-6">
                <x-input-label for="title" :value="__('messages.deal_title')" />
                <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                    placeholder="e.g. Software Licensing for 2026" required />
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <x-input-label for="status" :value="__('messages.initial_status')" />
                    <select name="status" id="status"
                        ...
                        <option value="negotiation">{{ __('messages.negotiation') }}</option>
                        <option value="proposal">{{ __('messages.proposal') }}</option>
